...
template <typename T>
T test_kronmult_batched(int const idim, int const n, int const batchCount,
...
#pragma omp parallel for
...
#ifdef USE_GPU
  {
    ...
    switch (idim) {
    case 1:
      kronmult1_batched<T><<<batchCount, nthreads>>>(
          n, dAarray_, dZarray_, dYarray_, dWarray_, batchCount);
      break;
    case 2:
      kronmult2_batched<T><<<batchCount, nthreads>>>(
          n, dAarray_, dZarray_, dYarray_, dWarray_, batchCount);
      break;
    case 3:
      kronmult3_batched<T><<<batchCount, nthreads>>>(
          n, dAarray_, dZarray_, dYarray_, dWarray_, batchCount);
      break;
    case 4:
      kronmult4_batched<T><<<batchCount, nthreads>>>(
          n, dAarray_, dZarray_, dYarray_, dWarray_, batchCount);
      break;
    case 5:
      kronmult5_batched<T><<<batchCount, nthreads>>>(
          n, dAarray_, dZarray_, dYarray_, dWarray_, batchCount);
      break;
    case 6:
      kronmult6_batched<T><<<batchCount, nthreads>>>(
          n, dAarray_, dZarray_, dYarray_, dWarray_, batchCount);
      break;
    default:
      expect(false);
...

  {
    ...
    switch (idim) {
    case 1:
      kronmult1_batched<T>(n, dAarray_, dZarray_, dYarray_, dWarray_,
                           batchCount);
      break;
    case 2:
      kronmult2_batched<T>(n, dAarray_, dZarray_, dYarray_, dWarray_,
                           batchCount);
      break;
    case 3:
      kronmult3_batched<T>(n, dAarray_, dZarray_, dYarray_, dWarray_,
                           batchCount);
      break;
    case 4:
      kronmult4_batched<T>(n, dAarray_, dZarray_, dYarray_, dWarray_,
                           batchCount);
      break;
    case 5:
      kronmult5_batched<T>(n, dAarray_, dZarray_, dYarray_, dWarray_,
                           batchCount);
      break;
    case 6:
      kronmult6_batched<T>(n, dAarray_, dZarray_, dYarray_, dWarray_,
                           batchCount);
      break;
    default:
      expect(false);
    ...
    for (int ibatch_table = 0; ibatch_table < size_batch_table;
      ...
      for (int in_table = 0; in_table < size_n_table; in_table++) {
        ...
        double const max_abserr =
            test_kronmult_batched<double>(idim, n, batchCount, idebug);
