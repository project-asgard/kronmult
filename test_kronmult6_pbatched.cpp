...
template <typename T>
T test_kronmult_pbatched(int const idim, int const n, int const batchCount,
                         int const idebug = 0, bool const do_check = true,
...
#pragma omp parallel for
...
#ifdef USE_GPU
  {
    ...
    switch (idim) {
    case 1:
      kronmult1_pbatched<T><<<batchCount, nthreads>>>(
          n, dAarray_, dpdZarray_, dpdYarray_, dpdWarray_, batchCount);
      break;
    case 2:
      kronmult2_pbatched<T><<<batchCount, nthreads>>>(
          n, dAarray_, dpdZarray_, dpdYarray_, dpdWarray_, batchCount);
      break;
    case 3:
      kronmult3_pbatched<T><<<batchCount, nthreads>>>(
          n, dAarray_, dpdZarray_, dpdYarray_, dpdWarray_, batchCount);
      break;
    case 4:
      kronmult4_pbatched<T><<<batchCount, nthreads>>>(
          n, dAarray_, dpdZarray_, dpdYarray_, dpdWarray_, batchCount);
      break;
    case 5:
      kronmult5_pbatched<T><<<batchCount, nthreads>>>(
          n, dAarray_, dpdZarray_, dpdYarray_, dpdWarray_, batchCount);
      break;
    case 6:
      kronmult6_pbatched<T><<<batchCount, nthreads>>>(
          n, dAarray_, dpdZarray_, dpdYarray_, dpdWarray_, batchCount);
      break;
    default:
      expect(false);
...

  {
    ...
    switch (idim) {
    case 1:
      kronmult1_pbatched<T>(n, dAarray_, dpdZarray_, dpdYarray_, dpdWarray_,
                            batchCount);
      break;
    case 2:
      kronmult2_pbatched<T>(n, dAarray_, dpdZarray_, dpdYarray_, dpdWarray_,
                            batchCount);
      break;
    case 3:
      kronmult3_pbatched<T>(n, dAarray_, dpdZarray_, dpdYarray_, dpdWarray_,
                            batchCount);
      break;
    case 4:
      kronmult4_pbatched<T>(n, dAarray_, dpdZarray_, dpdYarray_, dpdWarray_,
                            batchCount);
      break;
    case 5:
      kronmult5_pbatched<T>(n, dAarray_, dpdZarray_, dpdYarray_, dpdWarray_,
                            batchCount);
      break;
    case 6:
      kronmult6_pbatched<T>(n, dAarray_, dpdZarray_, dpdYarray_, dpdWarray_,
                            batchCount);
      break;
    default:
      expect(false);
...
int main() {
  ...
  for (int idim = 1; idim <= 6; idim++) {
    for (int ibatch_table = 0; ibatch_table < size_batch_table;
         ibatch_table++) {
      for (int in_table = 0; in_table < size_n_table; in_table++) {
        ...
        double const max_abserr =
            test_kronmult_pbatched<double>(idim, n, batchCount, idebug);
